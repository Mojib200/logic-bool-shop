...
@section('content')
       ...
       <div class="section ">
        <div class="hero-slider swiper-container slider-nav-style-1 slider-dot-style-1">
            ...
            <div class="swiper-wrapper">
                <!-- Single slider item -->
                <div class="hero-slide-item slider-height swiper-slide bg-color1" data-bg-image="{{'dashboard/'}}assets/images/hero/bg/hero-bg-1.webp">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 d-flex justify-content-center position-relative align-items-end">
                                <div class="show-case">
                                    <div class="hero-slide-image">
                                        <img src="{{'dashboard/'}}assets/images/hero/inner-img/hero-1-1.png" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container h-100">
                        <div class="row h-100">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 d-flex justify-content-center position-relative align-items-end">
                                <div class="show-case">
                                    <div class="hero-slide-image">
                                        <img src="{{'dashboard/'}}assets/images/hero/inner-img/hero-1-2.png" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="single-banner nth-child-1">
                        <img src="{{'dashboard/'}}assets/images/banner/3.webp" alt="">
                ...
                <div class="col-md-6">
                    <div class="single-banner nth-child-2 mb-30px mb-lm-30px mt-lm-30px ">
                        <img src="{{'dashboard/'}}assets/images/banner/4.webp" alt="">
                    ...
                    <div class="single-banner nth-child-2">
                        <img src="{{'dashboard/'}}assets/images/banner/5.webp" alt="">
                            ...
                            <div class="row mb-n-30px">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{'dashboard/'}}assets/images/product-image/1.webp" alt="Product" />
                                                <img class="hover-image" src="{{'dashboard/'}}assets/images/product-image/1.webp" alt="Product" />
                                            </a>
                                        </div>
                                        <div class="content">
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{'dashboard/'}}assets/images/product-image/2.webp" alt="Product" />
                                                <img class="hover-image" src="{{'dashboard/'}}assets/images/product-image/2.webp" alt="Product" />
                                            </a>
                                        </div>
                                        <div class="content">
                                            <span class="category"><a href="#">Accessories</a></span>
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{'dashboard/'}}assets/images/product-image/3.webp" alt="Product" />
                                                <img class="hover-image" src="{{'dashboard/'}}assets/images/product-image/3.webp" alt="Product" />
                                            </a>
                                        </div>
                                        <div class="content">
                                            <span class="category"><a href="#">Accessories</a></span>
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{'dashboard/'}}assets/images/product-image/4.webp" alt="Product" />
                                                <img class="hover-image" src="{{'dashboard/'}}assets/images/product-image/1.webp" alt="Product" />
                                            </a>
                                        </div>
                                        <div class="content">
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{'dashboard/'}}assets/images/product-image/5.webp" alt="Product" />
                                                <img class="hover-image" src="{{'dashboard/'}}assets/images/product-image/5.webp" alt="Product" />
                                            </a>
                                        </div>
                                        <div class="content">
                                            <span class="category"><a href="#">Accessories</a></span>
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{'dashboard/'}}assets/images/product-image/6.webp" alt="Product" />
                                                <img class="hover-image" src="{{'dashboard/'}}assets/images/product-image/6.webp" alt="Product" />
                                            </a>
                                        </div>
                                        <div class="content">
                                            <span class="category"><a href="#">Accessories</a></span>
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{'dashboard/'}}assets/images/product-image/7.webp" alt="Product" />
                                                <img class="hover-image" src="{{'dashboard/'}}assets/images/product-image/1.webp" alt="Product" />
                                            </a>
                                        </div>
                                        <div class="content">
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{'dashboard/'}}assets/images/product-image/8.webp" alt="Product" />
                                                <img class="hover-image" src="{{'dashboard/'}}assets/images/product-image/8.webp" alt="Product" />
                                            </a>
                                        </div>
                                        <div class="content">
                                            <span class="category"><a href="#">Accessories</a></span>
    ...
    <!-- Product Area End -->
    <!-- Fashion Area Start -->
    <div class="fashion-area" data-bg-image="{{'dashboard/'}}assets/images/fashion/fashion-bg.webp">
        <div class="container h-100">
                ...
                <div class="col-xl-6 col-lg-6 mb-md-35px mb-lm-35px">
                    <div class="single-feature-content">
                        <div class="feature-image">
                            <img src="{{'dashboard/'}}assets/images/feature-image/1.webp" alt="">
                        </div>
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="feature-right-content">
                        <div class="image-side">
                            <img src="{{'dashboard/'}}assets/images/feature-image/2.webp" alt=""> 
                            <button title="Add To Cart" class="action add-to-cart" data-bs-toggle="modal" data-bs-target="#exampleModal-Cart"><i
                                class="pe-7s-shopbag"></i></button>
                        </div>
                    ...
                    <div class="feature-right-content mt-30px">
                        <div class="image-side">
                            <img src="{{'dashboard/'}}assets/images/feature-image/3.webp" alt="">
                            <button title="Add To Cart" class="action add-to-cart" data-bs-toggle="modal" data-bs-target="#exampleModal-Cart"><i
                                class="pe-7s-shopbag"></i></button>
                        </div>
                        <div class="content-side">
                                ...
                                <div class="testi-inner">
                                    ...
                                    <div class="testi-author">
                                        <div class="author-image">
                                            <img class="img-responsive" src="{{'dashboard/'}}assets/images/testimonial/1.png" alt="">
                                        </div>
            ...
            <div class="brand-slider swiper-container">
                <div class="swiper-wrapper align-items-center">
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="{{'dashboard/'}}assets/images/partner/1.png" alt="" /></a>
                    </div>
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="{{'dashboard/'}}assets/images/partner/2.png" alt="" /></a>
                    </div>
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="{{'dashboard/'}}assets/images/partner/3.png" alt="" /></a>
                    </div>
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="{{'dashboard/'}}assets/images/partner/4.png" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-6 mb-xs-30px">
                    <div class="single-blog">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{'dashboard/'}}assets/images/blog-image/1.webp" class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="single-blog">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{'dashboard/'}}assets/images/blog-image/2.webp" class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date line-height-1">
                                <span class="blog-date"><i class="fa fa-calendar" aria-hidden="true"></i> 27,Jun 2030</span>
